  ...
  return (
    <div style={styles.container}>
      ...
      <nav style={styles.tabNav}>
        <button
          style={activeTab === 'checklist' ? {...styles.tabBtn, ...styles.tabBtnActive} : styles.tabBtn}
          onClick={() => setActiveTab('checklist')}
        >
          ✓ Checklist
        </button>
        <button
          style={activeTab === 'budget' ? {...styles.tabBtn, ...styles.tabBtnActive} : styles.tabBtn}
          onClick={() => setActiveTab('budget')}
        >
          💰 Budget
        </button>
        <button
          style={activeTab === 'timeline' ? {...styles.tabBtn, ...styles.tabBtnActive} : styles.tabBtn}
          onClick={() => setActiveTab('timeline')}
        >
          📅 Timeline
        </button>
        <button
          style={activeTab === 'notes' ? {...styles.tabBtn, ...styles.tabBtnActive} : styles.tabBtn}
              ...
              <div key={stepId} style={styles.stepCard}>
                <div style={styles.stepHeader}>
                  ...
                  <div style={styles.stepProgress}>
                    <span style={styles.stepProgressText}>{getStepProgress(stepId)}%</span>
                  </div>
                </div>
                ...
                <div style={styles.stepProgressBar}>
                  <div
                    style={{
                      ...
                      width: `${getStepProgress(stepId)}%`,
                      background: getStepProgress(stepId) === 100 ? '#27ae60' : '#667eea'
                    }}
                  ></div>
                </div>
                ...
                <ul style={styles.checklist}>
                  {step.items.map(item => (
                    ...
                    >
                      <span style={item.done ? styles.checkboxDone : styles.checkbox}>
                        {item.done ? '✓' : ''}
                      </span>
                      <span style={item.done ? styles.checklistTextDone : styles.checklistText}>
                        {item.text}
                      </span>
                      {item.category && (
                        <span style={{
        ...
        {activeTab === 'budget' && (
          <div>
            ...
            <div style={styles.grandTotal}>
              ...
              <span style={styles.grandTotalAmount}>${getGrandTotal().toLocaleString()}</span>
            </div>
          </div>
        )}
              ...
              {Object.entries(data.steps).map(([stepId, step]) => (
                <div key={stepId} style={styles.timelineItem}>
                  <div style={styles.timelineDot}>
                    {getStepProgress(stepId) === 100 ? '✓' : stepId}
                  </div>
                  <div style={styles.timelineContent}>
                    ...
                    <div style={styles.timelineProgress}>
                      ...
                      <span style={styles.timelineProgressText}>
